...
- After every serious code change, validate the current project state against `docs/plan.md` and `spec.md`, then include brief recommendations for the next most useful steps along that plan
